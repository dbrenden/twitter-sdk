...
var args22526 = [];
var len__20374__auto___22529 = arguments.length;
var i__20375__auto___22530 = (0);
while(true){
if((i__20375__auto___22530 < len__20374__auto___22529)){
args22526.push((arguments[i__20375__auto___22530]));

var G__22531 = (i__20375__auto___22530 + (1));
i__20375__auto___22530 = G__22531;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args22526.length)].join('')));
